...
const event = {
    summary: "Meeting with My group",
    location: 'University of Adelaide, SA',
    description: 'Meeting with them to talj about the project and hoe to add the google calenfar api',
    start:{
    ...
    calendar.freebusy.query({
        ...
        if (eventsArr.length === 0) return calendar.events.insert({calendarId: 'primary', resource: event},
         (err)=>{if(err){
             return console.error("Calendar Event Creatin Error", err);
         }else{
